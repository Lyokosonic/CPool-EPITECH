...
gcc -o my_str_to_word_array.o -c my_str_to_word_array.c
gcc -o my_show_word_array.o -c my_show_word_array.c
gcc -o my_params_to_array.o -c my_params_to_array.c
